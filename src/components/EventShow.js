        ...
        return (
            <ul>
                ...
                <div className="opacity-80 m-2 bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                    ...
                    <li className="mt-1 text-sm text-green-900 sm:mt-0 sm:col-span-1">
                        <button className="pl-2 pr-2 text-sm font-medium text-gray-900"><i className="fas fa-check completed"></i></button>      
                        <button className="pl-2 pr-2 text-sm font-medium text-gray-900"><i className="deleteCareEvent fa fa-trash content-end"></i></button>      
                    </li>
                </div>
            </ul>
        )
